...
function FlashcardViewer(): React.ReactElement {
  ...
  // Update this handler to connect with AlphabetQuiz
  const handleWritingSystemChange = (systemId: string) => {
    setSelectedWritingSystem(systemId);
  };
  ...
  return (
    <div className="card p-6">
      ...
      {mode === 'quiz' ? (
        <AlphabetQuiz
          writingSystemId={selectedWritingSystem}
          onSystemChange={handleWritingSystemChange}
        />
      ) : (
        <>
          <div className="mb-4">
